...
@Controller
public class PartDeleteSelectUserController {
	
	@Autowired
	PartDeleteSelectService service;
	
	@RequestMapping("/part/deleteUser")
	public String deleteUserPick( @RequestParam(value="idx", defaultValue = "1") int idx, Model model) {
