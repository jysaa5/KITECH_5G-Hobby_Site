  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="<c:url value="/dictionary/dictSearchForm"/>">우리말 사전 검색</a>
          <a class="dropdown-item" href="<c:url value="/dictionary/dictContentForm"/>">사전 내용 보기</a>
        </div>
      </li>
      ...
      <li class="nav-item">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          ...
          <a class="dropdown-item" href="<c:url value="/finance/depositProductsSearch"/>">정기예금상품</a>
          <a class="dropdown-item" href="<c:url value="/finance/annuitySavingProductsSearch"/>">연금저축상품</a>
          <a class="dropdown-item" href="<c:url value="/finance/rentHouseLoanProductsSearch"/>">전세자금대출</a>
          <a class="dropdown-item" href="<c:url value="/finance/mortgageLoanProductsSearch"/>">주택담보대출</a>
