...
table {
    width: 100%;
    border-top: 1px solid #E9CBD1; 
    border-collapse: collapse;
    margin: auto;
    text-align: center;
  }
th, td {
    border-bottom: 1px solid #E9CBD1;
    padding: 10px;
    white-space: nowrap;
  }
</style>
...
<!-- 해더 끝 -->
	...
	<main role="main" class="container">
		<div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded box-shadow" style ="width:200%;">
			<div class="lh-100">
				<h6 class="mb-0 text-white lh-100">적금상품 조회 결과</h6>
    ...
    <script type="text/javascript" charset="euc-kr">
        $(document).ready(function() {
            $.ajax({
                ...
                type: "GET",
                dataType: "xml",
                url: "http://finlife.fss.or.kr/finlifeapi/savingProductsSearch.xml?auth=7ca1f03b6f18f09837b676a3f0f2370c&topFinGrpNo=020000&pageNo=1",
                ...
                success: function(res) {
                    ...
                    $(xml).each(function() {
                        ...
                        if (save_trm_Data == '6') {
                            ...
                            save_trm = '12';
                        }else if(save_trm_Data == '2'){
                        	save_trm = '24';
                        	
                        }else if(save_trm_Data == '3') {
                            save_trm = '36';
                        }
