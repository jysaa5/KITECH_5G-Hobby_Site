      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <table class="table">
        	...
        	<tr>
        		...
        		<td>
        			<a href="<c:url value ="/part/edit?idx=${article.idx}"/>" class="btn btn-primary">수정</a>
        			<a href="<c:url value ="/part/deleteAdmin?idx=${article.idx}"/>" class="btn btn-danger">삭제</a>
        		</td>
        	</tr>       	
        	</c:forEach>
        	<!-- 리스트 끝 -->        	
        ...
        <div>
        	...
        	<a href="<c:url value ="/part/list?page=${i}"/>">[${i}]</a>
        	</c:forEach>
        </div>
      </div>
    </main>
