...
<body>
	...
	<main role="main" class="container">
		<div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded box-shadow" style ="width:200%;">
			...
			<div class="lh-100">
				<h6 class="mb-0 text-white lh-100">개인신용대출 조회 결과</h6>
    ...
    <script type="text/javascript" charset="euc-kr">
        $(document).ready(function() {
            $.ajax({
                ...
                type: "GET",
                dataType: "xml",
                url: "http://finlife.fss.or.kr/finlifeapi/creditLoanProductsSearch.xml?auth=7ca1f03b6f18f09837b676a3f0f2370c&topFinGrpNo=050000&pageNo=1",
                ...
                success: function(res) {
                    ...
                    $(xml).each(function() {
                        ...
                        var crdt_lend_rate_type_nm = $(this).find('options').find('option').find('crdt_lend_rate_type_nm').text().substring(0, 4);
                        var crdt_grad_avg = $(this).find('options').find('option').find('crdt_grad_avg').text().substring(0, 4);
                        ...
                        str += '<th>' + join_way + '</th>\n';
                        str += '<th>' + crdt_lend_rate_type_nm + '</th>\n';
                        str += '<th>' + crdt_grad_avg + '</th>\n';
                        str += '</tr>\n';
                    });
                    str += '</tbody>'
